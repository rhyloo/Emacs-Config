#+TITLE:  EMACS
#+DATE: [2022-12-26 Mon]
#+last_modified: 2025-08-22 13:07:51
#+AUTHOR: Rhyloo
...
(custom-set-faces
 '(dired-directory ((t (:inherit font-lock-keyword-face :weight bold)))))
  ...
  If you don't like emacs telling you about its guessing the offset, customize the variable 
  #+begin_src emacs-lisp
  (setq python-indent-guess-indent-offset-verbose nil)
  #+end_src

 EXPERIMENTAL Cambia el color de la agenda al día de hoy.
...
Experimental multiple minibuffers
#+begin_src emacs-lisp
(setq enable-recursive-minibuffers t)
(setq electric-pair-mode t)
#+end_src

Experimental Projectile
#+begin_src emacs-lisp
